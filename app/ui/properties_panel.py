...
class PropertiesPanel(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.btn_lock = QtWidgets.QPushButton("Toggle Lock")
        ...
        self.btn_reset_pose = QtWidgets.QPushButton("Reset All")
        ...
        depth_layout.addWidget(QtWidgets.QLabel("Move closer (left) / farther (right)"))
        depth_layout.addWidget(self.depth_slider)
        layout.addWidget(grp_depth)

        grp_edit = QtWidgets.QGroupBox("Edit Mode")
        edit_layout = QtWidgets.QVBoxLayout(grp_edit)
        self.btn_rotate_mode = QtWidgets.QPushButton("Rotate")
        self.btn_rotate_mode.setCheckable(True)
        self.btn_rotate_mode.setChecked(True)
        self.btn_rotate_mode.clicked.connect(lambda: self._set_edit_mode("rotate"))
        self.btn_ik_mode = QtWidgets.QPushButton("IK (Right-click)")
        self.btn_ik_mode.setCheckable(True)
        self.btn_ik_mode.clicked.connect(lambda: self._set_edit_mode("ik"))
        edit_layout.addWidget(self.btn_rotate_mode)
        edit_layout.addWidget(self.btn_ik_mode)
